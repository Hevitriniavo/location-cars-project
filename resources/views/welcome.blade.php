...
<head>
    ...
    <!--animate.css-->
    <link rel="stylesheet" href="{{assert("assets/css/animate.css")}}">
                        ...
                        <div class="row">
                            <div class="col-md-7 col-sm-12">
                                <div class="new-cars-img">
                                    <img src="{{asset("assets/images/new-cars-model/ncm1.png")}}" alt="img"/>
                                </div><!--/.new-cars-img-->
                            </div>
                ...
                <div class="new-cars-item">
                    <div class="single-new-cars-item">
                        <div class="row">
                            <div class="col-md-7 col-sm-12">
                                <div class="new-cars-img">
                                    <img src="{{asset("assets/images/new-cars-model/ncm2.png")}}" alt="img"/>
                                </div><!--/.new-cars-img-->
                            </div>
                            <div class="col-md-5 col-sm-12">
                                <div class="new-cars-txt">
                ...
                <div class="new-cars-item">
                    <div class="single-new-cars-item">
                        <div class="row">
                            <div class="col-md-7 col-sm-12">
                                <div class="new-cars-img">
                                    <img src="{{asset("assets/images/new-cars-model/ncm3.png")}}" alt="img"/>
                                </div><!--/.new-cars-img-->
                            </div>
                            <div class="col-md-5 col-sm-12">
                                <div class="new-cars-txt">
            ...
            <div class="row">
                    ...
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{asset("assets/images/featured-cars/fc1.png")}}" alt="cars">
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{asset("assets/images/featured-cars/fc2.png")}}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{asset("assets/images/featured-cars/fc3.png")}}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{asset("assets/images/featured-cars/fc4.png")}}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{asset("assets/images/featured-cars/fc5.png")}}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{asset("assets/images/featured-cars/fc7.png")}}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-featured-cars">
                        <div class="featured-img-box">
                            <div class="featured-cars-img">
                                <img src="{{asset("assets/images/featured-cars/fc8.png")}}" alt="cars">
                            </div>
                            <div class="featured-model-info">
                                <p>
                                    model: 2017
                ...
                <div class="col-sm-3 col-xs-12">
                    <div class="single-testimonial-box">
                        <div class="testimonial-description">
                            <div class="testimonial-info">
                                <div class="testimonial-img">
                                    <img src="{{asset("assets/images/clients/c2.png")}}" alt="image of clients person" />
                                </div><!--/.testimonial-img-->
                            </div><!--/.testimonial-info-->
                            <div class="testimonial-comment">
                                <p>
                ...
                <div class="col-sm-3 col-xs-12">
                    <div class="single-testimonial-box">
                        <div class="testimonial-description">
                            <div class="testimonial-info">
                                <div class="testimonial-img">
                                    <img src="{{asset("assets/images/clients/c3.png")}}" alt="image of clients person" />
                                </div><!--/.testimonial-img-->
                            </div><!--/.testimonial-info-->
                            <div class="testimonial-comment">
                                <p>
